...
class TestGoogleProvider:
    ...
    @patch('src.providers.google_provider.genai')
    ...
    def test_get_provider_name(self):
        ...
        with patch('src.providers.google_provider.genai'):
            provider = GoogleProvider(api_key="test_key")
    ...
    def test_validate_model_success(self):
        ...
        with patch('src.providers.google_provider.genai'):
            ...
            assert provider.validate_model("gemini-3-pro") is True
    ...
    @patch('src.providers.google_provider.genai')
    def test_send_prompt_mock_response(self, mock_genai):
        ...
        provider = GoogleProvider(api_key="test_key")
        result = provider.send_prompt("test prompt", "gemini-3-pro")
    ...
    @patch('src.providers.google_provider.genai')
    def test_send_prompt_with_grounding(self, mock_genai):
    ...
    @patch('src.providers.google_provider.genai')
    def test_send_prompt_api_error(self, mock_genai):
        ...
        with pytest.raises(Exception, match="Google API error"):
            provider.send_prompt("test prompt", "gemini-3-pro")
