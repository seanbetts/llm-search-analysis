...
def test_extra_links_render_numbered_mentions(monkeypatch):
  """Extra links should display all snippet mentions and matching influence summaries."""
  ...
  response = SimpleNamespace(
    ...
    citations=[
      SimpleNamespace(
        ...
        stance_tags=["supports"],
        provenance_tags=["news"],
        influence_summary="Aggregated influence.",
        mentions=[
          {"mention_index": 0, "snippet_cited": "S1", "influence_summary": "I1"},
          {"mention_index": 1, "snippet_cited": "S2", "influence_summary": "I2"},
        ],
        published_at=None,
        text_snippet=None,
      ),
